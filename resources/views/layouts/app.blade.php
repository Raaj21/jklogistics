                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @else
                            ...
                            <li><a class="nav-link" href="{{ route('branch.index') }}">Manage Branch</a></li>
                            <li><a class="nav-link" href="{{ route('service.index') }}">Manage service</a></li>
                            <li class="nav-item dropdown">
                                <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                   Service Master<span class="caret"></span>
                                </a>
                                 <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="{{ route('service.masterindex') }}">
                                        Add Master
                                    </a>
