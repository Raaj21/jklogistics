...
@section('content')
    ...
    <form action="{{ route('service.store') }}" method="POST" name= "serviceForm"  enctype="multipart/form-data" >
    	@csrf
         ...
         <div class="row">
		    ...
		    <div class="col-xs-12 col-sm-12 col-md-12">
		        <div class="form-group">
                    ...
                    <textarea class="tinymce-editor" name="description" class="form-control"></textarea>
		        </div>
		    </div>
		    <div class="col-xs-12 col-sm-12 col-md-12">
		        <div class="form-group">
